...
//         height="100"
//         width="100"
//         style={{ fill: formData.symbolColor || 'white' }}
//       />
//     );
//   };
...
//         height="150"
//         width="150"
//         style={{ fill: formData.accent_color || 'black' }}
//       />
//     );
//   };
...
//         <svg width={shieldSizes[formData.shieldSize] || 150} height={shieldSizes[formData.shieldSize] || 150} viewBox="0 0 200 200">
...
//     return (
//       <g>
//         <image href={`/svgs/${symbolFileName}.svg`} x="50" y="50" height="100" width="100" style={{ filter: `brightness(0) saturate(100%) invert(${colorMap[formData.symbolColor] ? 100 : 0}%)` }} />
//       </g>
//     );
//   };
...
//     return (
//       <g>
//         <image href={`/svgs/${accentFileName}.svg`} x="25" y="23" height="150" width="150" style={{ filter: `brightness(0) saturate(100%) invert(${colorMap[formData.accent_color] ? 100 : 0}%)` }} />
//       </g>
//     );
//   };
